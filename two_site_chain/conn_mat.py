...
class ConnectionAMatricesBase(nn.Module):
    ...
    Letters (stack order): w_k = {x1+c, x2+c, x1-c, x2-c, x1+x2}
    """
...
class ConnectionAMatricesFixedWithEps0(ConnectionAMatricesBase):
    ...
    def forward(self, x_in, cy_val=None):
        ...
        a_x1, a_x2 = self.build_matrices(x_in, ak_list, cy_val)
        a0_x1, a0_x2 = self.build_matrices(x_in, ak0_list, cy_val)

        return a_x1, a_x2, a0_x1, a0_x2
